...
import useCurrencyInfo from './hooks/currencyExchangeInfo';
...
function App() {
  ...
  const swap = () => {
    ...
    // Use the latest state values for amount and convertedAmount
    const newConvertedAmount = amount * currencyInfo[newTo];
    setFrom(newFrom);
    setTo(newTo);
    setAmount(String(newConvertedAmount));
